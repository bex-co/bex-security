...
- This is a **public repository** — follow `AGENTS.md`'s public-repository rules: no customer/tenant identifiers, credentials, scan targets or findings, private context, or nonpublic links in the commit message.
...
```
Shipped: a1b2c3d feat: add bex-security ACP dashboard support
```
